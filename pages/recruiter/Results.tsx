...
import { Button, Card, BackButton } from '../../components/Shared';
      ...
      <div className="min-h-screen bg-black text-white px-4 md:px-8 pb-12 pt-32 animate-in fade-in duration-700">
        ...
        <div className="max-w-6xl mx-auto space-y-8 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-white/10 pb-6">
            ...
            <BackButton onClick={onBack} label="Back to Dashboard" className="w-full md:w-auto" />
          </div>
    ...
    <div className="min-h-screen bg-black text-white px-4 md:px-8 pb-12 pt-32 animate-in fade-in duration-700">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
          <div className="flex items-center space-x-4">
            <BackButton onClick={() => setSelectedSession(null)} label="Back to Candidates" />
            <div>
